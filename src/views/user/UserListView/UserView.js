...
const URL = 'https://envios-api-service.onrender.com/api/guias/usuario/'+localStorage.getItem("user");
const URLT = 'https://envios-api-service.onrender.com/api/trackings/usuario/'+localStorage.getItem("user");
const URLE = 'https://envios-api-service.onrender.com/api/envios/usuario/'+localStorage.getItem("user");
