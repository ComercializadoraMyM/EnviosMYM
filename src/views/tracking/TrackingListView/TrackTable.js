...
const URL = 'https://envios-api-service.onrender.com/api/trackings';
...
export default function BasicTable() {
  ...
  useEffect(() => {
    ...
    const handleChangeBDTracking = async() => {
        ...
        await fetch("https://envios-api-service.onrender.com/api/trackings", {
          method: 'POST', 
          headers: {
    ...
    const handleChangeWHRBD = async() => {
        await fetch("https://envios-api-service.onrender.com/api/trackings/"+whrUpdate+'/'+idUpdate, {
          method: 'POST', 
        }).then(data=>{
        }); 
      }
      ...
      const handleDelete = async (idUp) => {
        await fetch("https://envios-api-service.onrender.com/api/trackings/" + idUp, {
          method: 'DELETE',
        }).then(data => {
        });
      }
