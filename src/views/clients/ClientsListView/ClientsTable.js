...
const URL = 'https://envios-api-service.onrender.com/api/clientes';
...
export default function BasicTable() {
  ...
  const [employees, setEmployees] = useState([]);
    ...
    const handleChangeTarBD = async() => {
        await fetch("https://envios-api-service.onrender.com/api/clientes/tarifa/"+tarNueva+'/'+idUpdate, {
          method: 'POST', 
        }).then(data=>{
        }); 
      }
    ...
    const handleChangeSegBD = async() => {
        await fetch("https://envios-api-service.onrender.com/api/clientes/seguro/"+segNueva+'/'+idUpdate, {
          method: 'POST', 
        }).then(data=>{
        }); 
      }
    ...
    const handleChangeDirBD = async() => {
        await fetch("https://envios-api-service.onrender.com/api/clientes/direccion/"+dirNueva+'/'+idUpdate, {
          method: 'POST', 
        }).then(data=>{
        }); 
      }
