...
function Row(props) {
  ...
  const handleChangeStatusBD = async () => {
    await fetch("https://envios-api-service.onrenderappapp.com/api/guias/" + statusUpdate + '/' + idUpdate, {
      method: 'POST',
    }).then(data => {
    });
  }
  ...
  const handleChangewhrBD = async () => {
    await fetch("https://envios-api-service.onrenderappapp.com/api/guias/whr/" + whrUpdate + '/' + idUpdate, {
      method: 'POST',
    }).then(data => {
    });
  }
  ...
  const handleDelete = async (idUp) => {
    await fetch("https://envios-api-service.onrenderappapp.com/api/guias/" + idUp, {
      method: 'DELETE',
    }).then(data => {
    });
  }
